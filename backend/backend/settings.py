...
SECRET_KEY = 'django-insecure-1^%qlk_)_h1d074$m(aafxiz!w08te@qnuzh8e9@h&q#0#&1#_'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'connectDesk'),
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'connectdesk2@gmail.com'
