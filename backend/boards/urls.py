...
from .views import BoardViewSet, ColumnViewSet, TaskViewSet, invite_member_view, AddBoardMember, update_column_position, update_task_position, TrackOperationAPI, WorkspaceActivityFeed, RemoveBoardMember
...
urlpatterns = [
    ...
    path('boards/<uuid:board_id>/remove-member/', RemoveBoardMember.as_view(), name='remove_board_member'),
